...
<br>
       ...
       <div class="row">
        ...
        $ambil = $koneksi->query("SELECT * FROM destinasi WHERE nama_kabupaten LIKE 'tobasa'");
       ...
       while($destinasi = $ambil->fetch_assoc())  {  ?>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item ftco-animate" style="padding-top: 15px">
          <div class="card h-100 ftco-animate">
            <img class="card-img-top" style="" height="200" src="foto_destinasi/tobasamosir/<?php echo $destinasi['foto_destinasi']; ?>" alt=""></a>
            <div class="card-body">
              <h3 class="card-title">
                <style type="text/css">
              #kiri
