...
<section class="riwayat">
	<div class="container">
		 <br>
            <br>
            <br>
		<h3>Riwayat Booking <?php echo $_SESSION["pelanggan"]["nama_pelanggan"]; ?></h3>
<br>
		<table id="customers">
			<thead>
				<tr>
          ...
          <th>Opsi</th>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="pembayaranbooking.php?id=<?php echo $pecah['id']?>" class="btn btn-success">Pembayaran</a></td>
				</tr>
				<?php $nomor++;?>
				<?php } ?>
			</tbody>
