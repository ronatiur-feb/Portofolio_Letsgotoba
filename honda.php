...
<?php 
        ...
        $ambil = $koneksi->query("SELECT * FROM transportasi WHERE nama_transportasi LIKE '%$inputan_pencarian%' AND brand LIKE 'honda'");
      }else {
        $ambil = $koneksi->query("SELECT * FROM transportasi WHERE brand LIKE 'honda'");
