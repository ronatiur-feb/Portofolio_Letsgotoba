 ...
 if (!isset($_SESSION["pelanggan"]) OR empty($_SESSION["pelanggan"]))
  {
 	...
 	$idpem = $_GET["id"];
 	$ambil = $koneksi->query("SELECT * FROM booking WHERE id='$idpem' ");
...
<br>
	...
	if (isset($_POST["Kirim"]))
	{
		...
		//simpan pembayaran
		$koneksi->query("INSERT INTO pembayaranbooking(id,nama,bank,jumlah,tanggal,bukti)
			VALUES('$idpem', '$nama', '$bank', '$jumlah', '$tanggal', '$namafiks') ");

		//update pemabelian dari pending menjadi sudah kirim pembayaran
		$koneksi->query("UPDATE booking SET status='Bukti pembayaran sudah terkirim' WHERE id_pembelian='$idpem' ");
