...
<?php 
        ...
        $ambil = $koneksi->query("SELECT * FROM transportasi WHERE nama_transportasi LIKE '%$inputan_pencarian%'");
      }else {
          ...
          <div class="card h-100 ftco-animate">
            ...
            <div class="card-body">
             ...
             <center><a><?php echo $pertransportasi['nama_transportasi'];?>  </a>
               <div class="two">
                    <span class="price">Rp.<?php echo number_format($pertransportasi['harga_transportasi']) ;?></span>
                  </div>
